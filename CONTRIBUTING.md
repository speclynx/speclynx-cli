# Contributing to SpecLynx CLI

Thank you for considering contributing to the SpecLynx CLI!
This document outlines the process for contributing to the SpecLynx CLI Repository.
...
-   **[Bug Report](https://github.com/speclynx/speclynx-cli/issues/new?assignees=&labels=bug&template=Bug_report.md&title=%5BBug%5D+)**
-   **[Feature Request](https://github.com/speclynx/speclynx-cli/issues/new?assignees=&labels=enhancement&template=Feature_request.md&title=%5BFeature%5D+)**
...
Thank you for helping build and improve the SpecLynx CLI!
